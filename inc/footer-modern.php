...
?>
                ...
                <div class="reveal-on-scroll">
                    <form id="contactFormMIS" style="background: white; padding: 32px; border-radius: 24px; box-shadow: 0 20px 50px -10px rgba(0,0,0,0.08); border: 1px solid var(--color-border-light);">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px; margin-bottom: 14px;">
                            <div>
                                <label class="form-mis-label" for="cf-name">Name *</label>
                                <input type="text" id="cf-name" name="name" class="form-mis-input" placeholder="Your name" required autocomplete="name">
                            </div>
                            <div>
                                <label class="form-mis-label" for="cf-email">Email *</label>
                                <input type="email" id="cf-email" name="email" class="form-mis-input" placeholder="you@example.com" required autocomplete="email">
                            </div>
                        </div>

                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px; margin-bottom: 14px;">
                            <div>
                                <label class="form-mis-label" for="cf-phone">Contact No. *</label>
                                <input type="tel" id="cf-phone" name="phone" class="form-mis-input" placeholder="+91 99999 99999" required autocomplete="tel">
                            </div>
                            <div>
                                <label class="form-mis-label" for="cf-city">City *</label>
                                <input type="text" id="cf-city" name="city" class="form-mis-input" placeholder="Your city" required autocomplete="address-level2">
                            </div>
                        </div>

                        <div style="margin-bottom: 14px;">
                            <label class="form-mis-label" for="cf-interested">Interested In *</label>
                            <select id="cf-interested" name="interested" class="form-mis-input" required>
                        ...
                        <div style="margin-bottom: 20px;">
                            <label class="form-mis-label" for="cf-message">Message</label>
                            <textarea id="cf-message" name="message" class="form-mis-input form-mis-textarea" placeholder="Tell us about your needs..."></textarea>
                        </div>
    ...
    <iframe name="hidden_iframe" id="hidden_iframe" title="Form submission target" aria-hidden="true" style="display:none;"></iframe>
    <script>
    (function(){
