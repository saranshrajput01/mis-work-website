...
?>
    ...
    <section class="benefits-section" style="padding-top: 0;">
        <div class="benefits-container">
            <div class="benefits-grid reveal-stagger" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
    ...
    <section class="feature-row-section is-light" style="padding: 40px 0 60px;">
        <div class="feature-row-container">
            <div style="border-radius: 16px; overflow: hidden; box-shadow: 0 8px 32px rgba(0,0,0,0.08); width: 100%; height: 400px;">
